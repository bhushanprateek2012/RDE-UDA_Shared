...
fileID = fopen('animal_data.csv', 'w');
%dataset = {'Deepfea_original', 'Deepfea_painting'};
dataset = {'animalO','animalP' };
                ...
                for kIter=[100 120 150 300]%[100]
                    ...
                    for NNIter=[10]
                        ...
                        for deltaItr=[.7]
                            ...
                            acc=max(AC);
                            datasetName=strcat(num2str(acc), '_',dataset{idx},'-vs-',dataset{idx1});
                            ...
                            fprintf("idx:%2.0f idx1:%2.0f %s, Acc: %.4f delta: %2.2f NN: %2.0f k: %2.0f eta: %0.2f sigma: %2.0f ck: %2.0f no_reps: %2.0f\n", ...
